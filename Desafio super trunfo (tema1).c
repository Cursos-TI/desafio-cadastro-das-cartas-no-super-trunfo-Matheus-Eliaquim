...
printf("Cadastro de cartas\n\n"); 
    ...
    if (densidade01 != 0) {
            superpoder01 = (float)populacao01 + area01 + pib01 + pturisticos01 + pibper01 + (1.0f / densidade01);
        } else {
            superpoder01 = (float)populacao01 + area01 + pib01 + pturisticos01 + pibper01; // Sem o inverso
